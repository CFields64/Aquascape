...
Shallows.prototype = {
	...
	create: function() {
		...
		//('Tileset name, 'key')
		this.map.addTilesetImage('shallowsSheet', 'shallowsheet');

		//map.setCollisionByExclusion([]);
		//(tileset layer name)
		mapLayer2 = this.map.createLayer('backDrop');
		mapLayer3 = this.map.createLayer('Decoration');
	  mapLayer4 = this.map.createLayer('blueSand');
	...
	update: function() {
		...
		this.game.physics.arcade.collide(this.player, mapLayer);
